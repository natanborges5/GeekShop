...
namespace GeekShop.IdentityServer.Initializer
{
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            {
                UserName = "natan-admin",
                Email = "natan-admin@gmail.com",
                EmailConfirmed = true,
                PhoneNumber = "+55(21)999933333",
                FirstName = "Natan",
                LastName = "Admin"
            };
            _user.CreateAsync(admin, "Natan123$").GetAwaiter().GetResult();
            ...
            {
                UserName = "natan-client",
                Email = "natan-client@gmail.com",
                EmailConfirmed = true,
                PhoneNumber = "+55(21)999933333",
                FirstName = "Natan",
                LastName = "Client"
            };
            _user.CreateAsync(client, "Natan123$").GetAwaiter().GetResult();
